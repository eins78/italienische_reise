...
<?php /* How to display all other posts. */ ?>
	...
	<?php endif; ?>
			...
			<div class="entry-meta">
				<?php twentyten_posted_on(); ?>
<!-- 				get costum taxonomy terms :: get_the_term_list( $id, $taxonomy, $before, $sep, $after )  -->
				<?php echo get_the_term_list( $post->ID, 'kte_reise_orte', '<br>Orte: ', ', ', '. ' ); ?> 
				<?php echo get_the_term_list( $post->ID, 'kte_reise_personen', '<br>Begleitung: ', ', ', '. ' ); ?> 
				<?php echo get_the_term_list( $post->ID, 'kte_reise_arbeiten', '<br>Arbeiten: ', ', ', '. ' ); ?> 
